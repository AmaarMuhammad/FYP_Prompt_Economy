      ...
      <div className="container">
        <div className="profile-container">
          ...
          <div className="my-purchases-section">
            <h2>My Purchases</h2>
            {loadingPurchases ? (
              <div className="loading-purchases">Loading purchases...</div>
            ) : purchases.length === 0 ? (
              ...
              <div className="purchases-grid">
                {purchases.map((purchase) => (
                  <Link
                    to={`/prompts/${purchase.prompt._id}`}
                    key={purchase._id}
                    className="purchase-card"
                  >
                    <div className="purchase-header">
                      <h3>{purchase.prompt.title}</h3>
                      <span className={`purchase-status ${purchase.status}`}>
                        {purchase.status}
                      </span>
                    </div>
                    <p className="purchase-category">{purchase.prompt.category}</p>
